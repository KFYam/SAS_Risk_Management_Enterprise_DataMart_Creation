...
/* For NBFIINS PD */
/* ************************************************************************************* */
%macro gen_NBFIINS_Exclusion(stdte=, rmp=);
	...
	data tmp_rmp;
		...
		/* Due to lack of cases for analysis, CIN without EAD would still be included for performance checking */
...
%mend;
%gen_NBFIINS_Exclusion(stdte=&st_BackMth.,	rmp=RMP2BIONBFIINS);
%gen_NBFIINS_Exclusion(stdte=&st_RptMth.,	rmp=RMP2BIONBFIINS);
