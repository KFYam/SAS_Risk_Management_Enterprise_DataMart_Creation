...
/* For PF PD */
/* ************************************************************************************* */
%macro gen_PF_Exclusion(stdte=, rmp=);
	...
	data tmp_rmp;
		...
		/* field of incompleted FS indicator does not exist in source file */
...
%mend;
%gen_PF_Exclusion(stdte=&st_BackMth.,	rmp=RMP2BIOPF);
%gen_PF_Exclusion(stdte=&st_RptMth.,	rmp=RMP2BIOPF);
