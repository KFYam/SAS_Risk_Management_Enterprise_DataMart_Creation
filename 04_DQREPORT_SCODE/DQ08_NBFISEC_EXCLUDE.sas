...
/* For NBFISEC PD */
/* ************************************************************************************* */
%macro gen_NBFISEC_Exclusion(stdte=, rmp=);
...
%mend;
%gen_NBFISEC_Exclusion(stdte=&st_BackMth.,	rmp=RMP2BIONBFISEC);
%gen_NBFISEC_Exclusion(stdte=&st_RptMth.,	rmp=RMP2BIONBFISEC);
